...
import static org.eclipse.che.sample.perspective.ide.CustomPerspective.OPERATIONS_PERSPECTIVE_ID;
...
public class SwitchPerspectiveAction extends Action implements CustomComponentAction {
  ...
  @Inject
  public SwitchPerspectiveAction(
  ...
  private void createButtons() {
    radioButtonGroup.addButton(
        "",
        localizationConstant.projectPerspective(),
        resources.icon(),
        event -> perspectiveManager.setPerspectiveId(PROJECT_PERSPECTIVE_ID));
    radioButtonGroup.addButton(
        "",
        localizationConstant.customPerspective(),
        resources.icon(),
